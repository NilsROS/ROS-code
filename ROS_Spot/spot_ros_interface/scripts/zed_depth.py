...
class depth_processing():
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/zedm/depth/depth_registered", Image, self.callback)
    ...
    def callback(self, depth_data):
        ...
        print('Image size: {width}x{height}'.format(width=depth_data.width,height=depth_data.height)) ## Check full width and compare to opencv width values.... Match pixelvalue to get depth at right point
